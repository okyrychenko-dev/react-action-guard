...
- **🎣 React Hooks First** - Built with modern React hooks for seamless integration
- **🔒 Declarative Blocking** - Define blocking rules with simple, readable code
- **🎯 Scope-Based Control** - Block specific parts of your UI or go global
- **⏱️ Scheduling Support** - Schedule blocking for maintenance windows or timed operations
- **✅ Conditional Blocking** - Block based on dynamic conditions and validation rules
- **💬 Confirmable Actions** - Built-in support for confirmation dialogs
- **🔌 Middleware System** - Extend functionality with custom middleware
- **📦 TypeScript** - Fully typed for the best developer experience
- **🪶 Lightweight** - Minimal bundle size with focused runtime dependencies
