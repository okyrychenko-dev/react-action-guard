...
interface BlockerConfig {
  ...
  /** Priority level (0-100, default: 50). Higher priority takes precedence */
  priority?: number;
}
```
...
- Use appropriate priority levels (0-100) to control precedence
...
- Don't set extremely high priority (>95) unless critical
