...
export type { GuardedScopeContextValue, GuardedScopeProviderProps } from "./context";
export {
  useGuardedAction,
  useGuardedButton,
  useGuardedField,
...
export { visuallyHiddenClassName, visuallyHiddenCss, visuallyHiddenStyle } from "./styles";
export type {
