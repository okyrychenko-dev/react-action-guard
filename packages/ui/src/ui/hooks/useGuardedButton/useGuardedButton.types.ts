...
import type { UseGuardedActionParams, UseGuardedActionReturn } from "../useGuardedAction";

export interface UseGuardedButtonParams<TButtonState = GuardedActionState> extends Omit<
  UseGuardedActionParams<TButtonState>,
  "getActionState"
> {
